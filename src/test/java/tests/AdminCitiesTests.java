...
public class AdminCitiesTests extends BasicTest{
    ...
    public void createNewCity() throws InterruptedException {
        ...
        citiesPage.getNewItemButton().click();
        citiesPage.waitForNewEditItemBoxToBeVisible();
        citiesPage.getNewItemInput().sendKeys("San Diego");
    ...
    public void editCity() throws InterruptedException {
        ...
        citiesPage.getInputSearchButton().sendKeys("San Diego");
        ...
        citiesPage.getNewItemInput().sendKeys("Los Angeles");
        citiesPage.getSaveButton().click();
    ...
    public void searchCity() throws InterruptedException {
        ...
        citiesPage.getInputSearchButton().sendKeys("Los Angeles");
        citiesPage.waitForNumbersOfRowsToBe(1);

        Thread.sleep(1500);

        Assert.assertTrue(citiesPage.getTableCell(1,2).getText().contains("Los Angeles"),
